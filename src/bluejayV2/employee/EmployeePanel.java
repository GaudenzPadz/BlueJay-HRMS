...
public class EmployeePanel extends JPanel {
    ...
    public EmployeePanel() {
        ...
        menuPanel.setLayout(new MigLayout("center", "[grow,fill][200][100][200][100][200][grow,fill]", "[100px][][10px:30px:50px][grow][10px:30px:50px]"));
    	
        ImageIcon profileIcon = new ImageIcon(getClass().getResource("/images/96x96/profile.png"));
        
        ButtonPanel panel_2 = new ButtonPanel(Color.decode("#002C4B"), profileIcon, "View/Update Profile", " click to view or update profile information ");
        ...
        ButtonPanel panel_1 = new ButtonPanel(Color.decode("#002C4B"), attendanceIcon, "Check/Update Attendance", "     click to check or update attendance     ");
        ...
        ButtonPanel panel_4 = new ButtonPanel(Color.decode("#002C4B"), payrollIcon, "Check/Update Payroll", "      click to check or update Payroll       ");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.getContentPane().add(new EmployeePanel(), BorderLayout.CENTER);
